      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="#" class="small-box-footer">Mais informaçõe <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
...
echo '
      ...
      <div class="row">
        ...
        <h3><a href="https://github.com/marciodutra?tab=projects" target="_blank">Link para o GITHUB</a></h3>
        <p>Acesse mei GIT e conheça meus projetos</p>       
