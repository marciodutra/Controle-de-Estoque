...
*/
$url = 'http://localhost/Controle-de-Estoque/views/'; // Remova em caso de utilizar o código para hospedagem web 
...
$header = '<header class="main-header">
    ...
    <a href="' . $url . '" class="logo">
      ...
      <span class="logo-lg"><b>Sistema</b>Cadastro</span>
    </a>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      ...
                      <p>Por que não comprar um novo tema?</p>
                    </a>
                  </li>
                  <!-- end message -->
                  <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      ...
                      5 novos membros se juntaram
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <i class="fa fa-shopping-cart text-green"></i> 25 vendas realizadas
                    </a>
                  </li>
                  <li>
                    <a href="#">
...
$footer = '<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2024 <a href="https://github.com/marciodutra?tab=projects">Márcio Dutra</a>.</strong> 
    Todos os direitos
        reservado.
  </footer>
